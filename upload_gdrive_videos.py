...
TARGET_FOLDER_NAME = "Anime_Short"  # Updated folder name (without the 's')
DIRECT_FOLDER_MODE = True  # Set to True to process videos directly from the main folder instead of subfolders
SPREADSHEET_ID = '1x1mF5KnMYJZ6P9J2661qVqtwhRje-lB33coZlCbAddo'  # New spreadsheet ID
SHEET_NAME = 'Sheet1'
...
DEFAULT_YOUTUBE_CHANNEL = "AnimeClash"  # Default channel to use if none specified

# Telegram Bot configuration
TELEGRAM_BOT_TOKEN = "8139934667:AAHKP6b5qa2POhb7Q7hUdOD5fEDCj_wLssA"
TELEGRAM_CHAT_ID = "-1002493560505"
TELEGRAM_THREAD_ID = 1577
...
def get_google_drive_credentials():
    ...
    CREDENTIALS_DRIVE_LINK = "https://drive.google.com/file/d/12NdhfbvI6BOyZVTdUmiCvUtBEEqJClWj/view?usp=sharing"
...
def process_folder_for_upload(folder_data, row_index, channel_id=None, channel_name=None):
    ...
    token_folder = None
    # Group 1: AnimeClash, AniSnap, KawaiiCuts, OtakuPulse, SenpaiSnaps
    if channel_name in ["AnimeClash", "AniSnap", "KawaiiCuts", "OtakuPulse", "SenpaiSnaps"]:
        # These channels use first token group
        if channel_name == "AnimeClash":
            token_folder = "tokens_anime_channel_1"
        elif channel_name == "AniSnap":
            token_folder = "tokens_anime_channel_2"
        elif channel_name == "KawaiiCuts":
            token_folder = "tokens_anime_channel_3"
        elif channel_name == "OtakuPulse":
            token_folder = "tokens_anime_channel_4"
        elif channel_name == "SenpaiSnaps":
            token_folder = "tokens_anime_channel_5"
    # Group 2: ShinobiSnips, ShortsCrazy, UltraInstinctEdits, VoidNoJutsu, ZenkaiZone
    elif channel_name in ["ShinobiSnips", "ShortsCrazy", "UltraInstinctEdits", "VoidNoJutsu", "ZenkaiZone"]:
        # These channels use second token group
        if channel_name == "ShinobiSnips":
            token_folder = "tokens_anime_channel_6"
        elif channel_name == "ShortsCrazy":
            token_folder = "tokens_anime_channel_7"
        elif channel_name == "UltraInstinctEdits":
            token_folder = "tokens_anime_channel_8"
        elif channel_name == "VoidNoJutsu":
            token_folder = "tokens_anime_channel_9"
        elif channel_name == "ZenkaiZone":
